...
def convert_xml_content(data):
    ...
    for c in data['value']:
        ...
        ordDict = xmltodict.parse(myDoc) # parse out the xml, and convert to ordered dictionary
        newDict = json.loads(json.dumps(ordDict)) # convert to regular dictionary ('unnecessary')
